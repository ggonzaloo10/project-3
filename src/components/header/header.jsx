...
export default function Header() {
    ...
    return <header>
        ...
        <div onClick={onOff} className="menu-icon">
            ...
            <svg className={stateMenu ? "visible" : "invisible"} width="48" height="31" viewBox="0 0 48 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={stateMenu ? "invisible" : "visible"} width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={stateMenu ? "invisible" : "menu-links"}>
            <a href="">Projects</a>
            <a href="">About me</a>
            <a href="">Contact</a>
